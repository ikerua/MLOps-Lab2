...
@click.option(
    "--width", "-w", required=True, type=int, help="Nuevo ancho de la imagen."
)
@click.option(
    "--height", "-h", required=True, type=int, help="Nuevo alto de la imagen."
)
@click.option(
    "--output", "-o", default="resized_output.png", help="Ruta del archivo de salida."
)
